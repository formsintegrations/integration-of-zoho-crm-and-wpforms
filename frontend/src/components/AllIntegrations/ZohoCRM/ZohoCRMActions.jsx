    ...
    <div className="pos-rel">
      {!isPro && (
        <div className="pro-blur flx w-10" style={{ top: -25 }}>
          <div className="pro">
            ...
            <a
              href="https://formsintegrations.com/wpforms-integration-with-zoho-crm/"
              target="_blank"
              rel="noreferrer"
            >
              <span className="txt-pro"> {__('Premium', 'bitwpfzc')}</span>
            </a>
          </div>
        </div>
      )}
      <div className="d-flx flx-wrp">
        <TableCheckBox
          ...
          value="Workflow"
          title={__('Workflow', 'bitwpfzc')}
          subTitle={__('Trigger CRM workflows', 'bitwpfzc')}
        />
        <TableCheckBox
          ...
          className="wdt-200 mt-4 mr-2"
          value="Attachment"
          title={__('Attachment', 'bitwpfzc')}
          subTitle={__('Add attachments or signatures from BitForm to CRM.', 'bitwpfzc')}
        />
        <TableCheckBox
          ...
          className="wdt-200 mt-4 mr-2"
          value="Approval"
          title={__('Approval', 'bitwpfzc')}
          subTitle={__('Send entries to CRM approval list.', 'bitwpfzc')}
        />
        <TableCheckBox
          ...
          className="wdt-200 mt-4 mr-2"
          value="Blueprint"
          title={__('Blueprint', 'bitwpfzc')}
          subTitle={__('Trigger CRM Blueprint', 'bitwpfzc')}
        />
        <TableCheckBox
          ...
          className="wdt-200 mt-4 mr-2"
          value="Capture_GCLID"
          title={__('Capture GCLID', 'bitwpfzc')}
          subTitle={__('Sends the click details of AdWords Ads to Zoho CRM.', 'bitwpfzc')}
        />
        <TitleModal action={openUpsertModal}>
          <TableCheckBox
            ...
            className="wdt-200 mt-4 mr-2"
            value="Upsert_Record"
            title={__('Upsert Records', 'bitwpfzc')}
            subTitle={__(
        ...
        <TableCheckBox
          onChange={() => setActionMdl({ show: 'assignment_rules' })}
          checked={
            tab === 0
          ...
          subTitle={__('Trigger Assignment Rules in Zoho CRM.', 'bitwpfzc')}
        />
        <TableCheckBox
          ...
          subTitle={__('Add a tag to records pushed to Zoho CRM.', 'bitwpfzc')}
        />
        <TableCheckBox
          onChange={() => setActionMdl({ show: 'rec_owner' })}
          checked={
            tab === 0
          ...
          subTitle={__('Add a owner to records pushed to Zoho CRM.', 'bitwpfzc')}
        />
      </div>
      ...
      >
        ...
        <MultiSelect
          ...
          options={formFields
            ...
            .map(itm => ({ label: itm.name, value: itm.key }))}
        />
      </ConfirmModal>
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            ...
            <button
              ...
              style={{ '--tooltip-txt': `'${__('Refresh CRM Assignment Rules', 'bitwpfzc')}'` }}
              type="button"
              disabled={isLoading}
            >
              &#x21BB;
      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            ...
            <button
              className="icn-btn sh-sm ml-2 mr-2 tooltip"
              style={{ '--tooltip-txt': `${__('Refresh CRM Tags', 'bitwpfzc')}'` }}
              type="button"
              disabled={isLoading}
            >
              &#x21BB;
      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="flx flx-between mt-2">
            ...
            <button
              className="icn-btn sh-sm ml-2 mr-2 tooltip"
              style={{ '--tooltip-txt': `'${__('Refresh CRM Owners', 'bitwpfzc')}'` }}
              type="button"
              disabled={isLoading}
            >
              &#x21BB;
      ...
      <Modal md show={upsertMdl} setModal={setUpsertMdl} title={__('Upsert Record', 'bitwpfzc')}>
        <div className="o-a">
          {tab === 0
