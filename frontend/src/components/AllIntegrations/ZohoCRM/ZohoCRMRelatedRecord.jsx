  ...
  return (
    <>
        ...
        <div className="pos-rel">
          ...
          >
            ...
            {crmConf?.default?.relatedlists?.[crmConf.module] &&
              Object.values(crmConf.default.relatedlists[crmConf.module]).map(relatedlistApiName => (
          ...
          <button
            ...
            style={{ '--tooltip-txt': `'${__('Refresh CRM Related Lists', 'bitwpfzc')}'` }}
            type="button"
            disabled={isLoading}
          >
            &#x21BB;
      ...
      {crmConf.default?.layouts?.[crmConf?.relatedlists?.[tab - 1]?.module]?.[
        ...
        <>
          <div className="mt-4">
            <b className="wdt-100">{__('Field Map', 'bitwpfzc')}</b>
          </div>
          <div className="btcd-hr mt-1" />
          <div className="flx flx-around mt-2 mb-1">
            <div className="txt-dp">
              <b>{__('Form Fields', 'bitwpfzc')}</b>
            </div>
            <div className="txt-dp">
              <b>{__('Zoho Fields', 'bitwpfzc')}</b>
            </div>
          </div>
          ...
          {crmConf.default?.layouts[crmConf.relatedlists[tab - 1].module]?.[
            ...
            Object.keys(
              ...
              <div className="pos-rel">
                ...
                <div className="mt-4">
                  <b className="wdt-100">{__('File Upload Field Map', 'bitwpfzc')}</b>
                </div>
                <div className="btcd-hr mt-1" />
                <div className="flx flx-around mt-2 mb-1">
                  <div className="txt-dp">
          ...
          <div className="mt-4">
            <b className="wdt-100">{__('Actions', 'bitwpfzc')}</b>
          </div>
          <div className="btcd-hr mt-1" />
