...
function Table(props) {
  ...
  const showBulkDupMdl = () => {
    ...
    confMdl.body = `${__('Do You want Deplicate these', 'bitwpfzc')} ${selectedFlatRows.length} ${__(
      'item',
      'bitwpfzc'
    )} ?`
    confMdl.show = true
  ...
  const showStModal = () => {
    ...
    confMdl.body = `${__('Do you want to change these', 'bitwpfzc')} ${selectedFlatRows.length} ${__(
      'status',
      'bitwpfzc'
    )} ?`
    confMdl.show = true
  ...
  const showDelModal = () => {
    ...
    confMdl.btn2Txt = null
    confMdl.btnClass = ''
    confMdl.body = `${__('Are you sure to delete these', 'bitwpfzc')} ${selectedFlatRows.length} ${__(
      'items',
      'bitwpfzc'
    )} ?`
    confMdl.show = true
          ...
          {props.rowSeletable && selectedFlatRows.length > 0 && (
            <>
              ...
              <small className="btcd-pill">
                {selectedFlatRows.length} {__('Row Selected', 'bitwpfzc')}
              </small>
            </>
          )}
        </div>
      ...
      <div className="btcd-pagination">
        ...
        <div>
          ...
          <small>
            ...
            {__('Page', 'bitwpfzc')}{' '}
            <strong>
              {pageIndex + 1} {__('of', 'bitwpfzc')} {pageOptions.length} &nbsp;
            </strong>{' '}
          </small>
          {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
          <label>
