...
function Settings() {
  const [erase, setErase] = useState(bitwpfzc && bitwpfzc.erase_all)
  ...
  const toggleEraseAll = (e) => {
    ...
    bitsFetch(data, 'erase_all')
      .then(res => {
        ...
        setSnackbar({ ...{ show: true, msg: __('Failed to toggle', 'bitwpfzc') } })
      })
  }
          ...
          <div className="flx flx-between sh-sm br-10 btcd-setting-opt">
            <div>
              <b>
                ...
                {__('Erase all data of this plugin in deletion', 'bitwpfzc')}
              </b>
            </div>
