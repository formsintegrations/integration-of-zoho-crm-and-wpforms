  ...
  return (
    <>
      ...
      <select onChange={handleInput} name="layout" value={crmConf.layout} className="btcd-paper-inp w-7">
        ...
        <option value="" disabled>{__('More layouts on the Pro version', 'bitwpfzc')}</option>
      </select>
      <button onClick={() => refreshLayouts(tab, formID, crmConf, setCrmConf, setisLoading, setSnackbar)} className="icn-btn sh-sm ml-2 mr-2 tooltip" style={{ '--tooltip-txt': `'${__('Refresh CRM Layouts', 'bitwpfzc')}'` }} type="button" disabled={isLoading}>&#x21BB;</button>
      <br />
      <br />
          ...
          <>
            ...
            {Object.keys(crmConf.default.layouts[crmConf.module][crmConf.layout]?.fileUploadFields).length !== 0 && (
              <div className="pos-rel">
                ...
                <div className="mt-4"><b className="wdt-100">{__('Map File Upload Fields', 'bitwpfzc')}</b></div>
                <div className="btcd-hr mt-1" />
                <div className="flx flx-around mt-2 mb-1">
                  <div className="txt-dp"><b>{__('Form Fields', 'bitwpfzc')}</b></div>
                  <div className="txt-dp"><b>{__('Zoho Fields', 'bitwpfzc')}</b></div>
