  ...
  return (
    <div style={{ width: 900 }}>
      ...
      <div className="flx mt-3">
        <b className="wdt-100 d-in-b">{__('Integration Name:', 'bitwpfzc')}</b>
        <input className="btcd-paper-inp w-7" onChange={e => handleInput(e, tab, crmConf, setCrmConf)} name="name" value={crmConf.name} type="text" placeholder={__('Integration Name...', 'bitwpfzc')} />
      </div>
