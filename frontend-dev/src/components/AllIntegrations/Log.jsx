...
function Log({ allIntegURL, integrations }) {
  ...
  const [cols, setCols] = useState([
    { width: 250, minWidth: 80, Header: __('Status', 'bitwpfzc'), accessor: 'response_type'},
    { width: 250, minWidth: 80, Header: __('Record Type', 'bitwpfzc'), accessor: 'api_type'},
    { width: 220, minWidth: 200, Header: __('Response', 'bitwpfzc'), accessor: 'response_obj', Cell: val => <CopyText value={val.row.values.response_obj} setSnackbar={setSnackbar} className="cpyTxt" /> },
    { width: 220, minWidth: 200, Header: __('Date', 'bitwpfzc'), accessor: 'created_at' },
 ])
    ...
    <>
      ...
      <div className="flx">
        ...
        <div className="w-8 txt-center">
          ...
          <div>{__('Integration Log', 'bitwpfzc')}</div>
        </div>
      </div>
